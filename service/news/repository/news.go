...
func (repo *NewsRepositoryImpl) AddMessage(ctx context.Context, message Message) (Message, error) {
...
func (repo *NewsRepositoryImpl) SearchMessageByUserID(ctx context.Context, userID int32) ([]*Message, error) {
...
func (repo *NewsRepositoryImpl) SearchMessageByCourseID(ctx context.Context, courseID int32) ([]*Message, error) {
	var messages []*Message
...
func (repo *NewsRepositoryImpl) SearchNewMessageByUserID(ctx context.Context, userID int32) ([]*Message, error) {
	var messages []*Message
